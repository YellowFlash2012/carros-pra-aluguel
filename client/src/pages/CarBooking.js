            ...
            >
                ...
                >
                    ...
                    <div>
                        ...
                        <Checkbox onChange={(e) => (e.target.checked ? setDriverNeeded(true) : setDriverNeeded(false))}>Driver Needed</Checkbox>
                        
                        <h2>
                            Total Due: $<b>{totalDue}</b>
                        </h2>

                        <button className="booking-btn" onClick={carBookingHandler}>Book Now</button>
                    </div>
                </Col>
            </Row>}
        </DefaultLayout>
